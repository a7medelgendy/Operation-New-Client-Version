          ...
          <Box sx={{ display: 'flex', mr: 2 }}>
            <Button
              sx={{
                ...
                //backgroundColor: activePage === 'about' ? '#e53935 ' : 'transparent', // Change button background when active
                color: activePage === 'about' ? 'white' : '#b0bec5', // Change font color when active (to red)
                borderBottom: activePage === 'about' ? '4px solid #e53935' : 'none', // Add red border when active
                '&:hover': {
                  // backgroundColor: activePage === 'about' ? '#90a4ae' : '#545b61', // Keep the hover effect but adapt to active state
